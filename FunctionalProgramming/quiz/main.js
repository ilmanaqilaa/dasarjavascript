...
const books = [
  ...
  // .filter((sale) => sale.sales > 1000000)
  // .map((author, title) => `${author.author} adalah penulis buku ${title.title} yang sangat hebat!`);
  // console.log(greatAuthors);

  // const hasil = greatAuthors.map((author, title) => {
  //   return `${author.author} adalah penulis buku ${title.title} yang sangat hebat!`
  // });
