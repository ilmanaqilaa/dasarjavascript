...
function scoreChecker(score) {
  ...
  if (score >= 90) {
    result = "Nilai ujian anda adalah A.";
  } else if (score >= 80 && score <= 89) {
    result = "Nilai ujian anda adalah B.";
  } else if (score >= 70 && score <= 79) {
    result = "Nilai ujian anda adalah C.";
  } else if (score >= 60 && score <= 69) {
    result = "Nilai ujian anda adalah D.";
  } else {
    result = "Nilai ujian anda adalah E.";
  }
