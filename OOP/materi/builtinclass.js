...
console.log('Ini adalah waktu di Jakarta',timeInJakarta);
console.log('Ini adalah waktu di Tokyo', timeInTokyo);
console.log('Ini adalah waktu di Makassar', timeInMakassar);
console.log();
